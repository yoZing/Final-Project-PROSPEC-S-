...
<!--                     <h1>공지사항 등록</h1> -->
                ...
                <div class="col-sm-6 d-none d-sm-block">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<%=request.getContextPath()%>/dashboard.do">Home /</a> 마이페이지 </li>
...
function initCalPage() {
   ...
   function ini_events(ele) {
	...
	function check() {
       ...
       $.ajax({
	         url        :   "<%=request.getContextPath()%>/myPage/calendar/check",
	        type        :   "post",
	    			  ...
	    			  if (result.isConfirmed) {
	    				var jsonMap = {};
	    		  	    ...
	    		  	    jsonMap["end"]=info.event._instance.range.end;
	    					...
	    					console.log(jsonMap);
	    		        $.ajax({
	    		   	         url        :   "<%=request.getContextPath()%>/myPage/calendar/dragModify",
	    		   	        type        :   "post",
	    		   	        contentType :   "application/json; charset=UTF-8",
	    		   	        dataType    :   "json",
