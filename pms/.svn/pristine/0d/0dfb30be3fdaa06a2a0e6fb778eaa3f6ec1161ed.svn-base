			...
			<div class="card-body">
				<div id="originTitleDiv" class="d-flex justify-content-between">
					<h5 class="d-flex align-items-center" id="originTitle">
						...
						<c:if test="${issue.gradeCode eq 'ordinary' }">				
							<span id="gradeCode" class="bg-warning px-3 py-2 mr-2" style="font-size:15px">보통</span>
						</c:if>
				...
				<div id="modifyTitleDiv" class="d-none">
					<select name="gradeCode" id="modifygradeCode" class="custom-select rounded-0 col-1 mr-2 mb-1" style="display:inline-block;">
						<option id="modifygradeCode" value="urgent">긴급</option>
						<option id="modifygradeCode" value="ordinary">보통</option>
						<option id="modifygradeCode" value="low">낮음</option>
					</select>
